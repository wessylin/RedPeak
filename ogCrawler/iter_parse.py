...
# title = input('Anything in particular you are looking for in the title?')
# title = ' allintitle: {}'.format(title)
# print(title)
content = input('Anything in particular you are looking for in the TEXT?')
content = ' allintext: {}'.format(content)
# print(content)

url = 'https://google.com/search?q=' + text + content
